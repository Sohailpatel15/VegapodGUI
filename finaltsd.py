...
x2_data = []  # List to store x-axis data
y2_data = []  # List to store y-axis data
    ...
    def update_table_rows(self, data):
        ...
        if chunks[0] == "start" and chunks[-1] == "stop":
            ...
            if len(values) >= 42:
                ...
                line2 = float(values[42])
                y_data.append(line2)  # Append y-axis data

                self.graph_widget.update_graph(x2_data, y2_data)
